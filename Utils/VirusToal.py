...
class VirusTotal:
    ...
    def lookup_hash(self):
        ...
        params = {'apikey': self.api_key, 'resource': 'fcc1bd24951b5dca31147bbc33d3566c23fb1a78a9afcbb62d0ae9e7695517ed'}
        headers = {
        ...
        positives_results = []
        if positives > 0:
            print 'Found ' + str(positives) + '/' + str(total) + ' positive Virus Results'
